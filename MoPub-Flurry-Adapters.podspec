...
s.subspec 'MoPub' do |ms|
  ...
  ms.dependency 'mopub-ios-sdk/NativeAds', '~> 5.6'
end
s.subspec 'Network' do |ns|
  ns.source_files = 'Flurry/*.{h,m}'
  ns.dependency 'Flurry-iOS-SDK/FlurrySDK', '10.0.2'
  ns.dependency 'Flurry-iOS-SDK/FlurryAds', '10.0.2'
  ns.dependency 'mopub-ios-sdk/Core', '~> 5.6'
  ns.dependency 'mopub-ios-sdk/NativeAds', '~> 5.6'
end
end
